...
import { DASH, SUCCESS_COLOR } from '../../config/animations';
...
const CircleWrapper = styled.circle<CircleProps>`
    ${props =>
        props.isRoute &&
        css`
            stroke: ${props.transparentRoute ? 'transparent' : colors.BORDER};
        `}
    ...
    ${props =>
        ...
        css`
            ...
            animation: ${DASH} 1.5s ease-in-out infinite,
                ${props.animationColor || SUCCESS_COLOR} 6s ease-in-out infinite;
...
const StyledParagraph = styled(Paragraph)<Props>`
    ...
    color: ${props => (props.isWhiteText ? colors.MAIN : colors.TEXT_PRIMARY)};
`;
