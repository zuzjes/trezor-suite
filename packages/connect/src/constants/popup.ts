...
export const BOOTSTRAP = '@trezor-connect/popup/bootstrap';
...
export const HANDSHAKE = '@trezor-connect/popup/handshake';
...
export const CLOSED = '@trezor-connect/popup/closed';
...
export const CANCEL_POPUP_REQUEST = '@trezor-connect/ui/cancel-popup-request';
...
export const CLOSE_WINDOW = '@trezor-connect/window.close';
